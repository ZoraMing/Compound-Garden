...
const getChapters = (lang: Language): ChapterConfig[] => {
  ...
  return [
    ...
    },
    {
      ...
      description: isZh
        ? "现在，我们给你的钱施一点魔法（复利）。哪怕只有一点点利率，粉色的线条（收益）开始出现在蓝色的线条（本金）之上。"
        : "Now let's add some magic (Compound Interest). Even with a small rate, the pink line (Interest) starts to appear above the blue line (Principal).",
    ...
    },
    {
      ...
      description: isZh
        ? "复利需要时间的滋养。试着把时间拉长。注意看，到了后期，粉色的收益是如何超越蓝色的本金的。这就是指数爆炸。"
        : "Compound interest needs time. Extend the duration. Notice how eventually, the pink interest overtakes the blue principal. This is exponential explosion.",
    ...
    },
    {
      ...
      defaultParams: { principal: 20000, monthlyContribution: 1000, monthlyExpenses: 3000, interestRate: 5, duration: 20, durationUnit: 'years' },
    ...
    },
    {
      ...
      defaultParams: { principal: 50000, monthlyContribution: 3000, monthlyExpenses: 3000, interestRate: 7, duration: 25, durationUnit: 'years' },
